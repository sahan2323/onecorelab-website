"use client";
// Source: 21st.dev — ddoemonn/password-strength
// https://21st.dev/r/ddoemonn/password-strength
// Retrieved via the 21st.dev MCP connector and wired into staff account
// creation/reset per the brief. Logic left intact; only integrated as-is.
